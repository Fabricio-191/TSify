...
interface commandMetadata {
	webCommandMetadata: webCommandMetadata | webCommandMetadata26 | webCommandMetadata97;
}
...
interface webCommandMetadata97 {
	...
	initialData: {
		...
		topbar: {
			desktopTopbarRenderer: {
				...
				forwardButton: dismissButton;
				a11ySkipNavigationButton: dismissButton;
				voiceSearchButton: dismissButton;
			};
		};
		microformat: {
