...
export interface navigationEndpoint {
	...
	signInEndpoint?: signInEndpoint | {
		...
		nextEndpoint: clickTracking | navigationEndpoint | navigationEndpoints;
		idamTag?: string;
...
export interface menuRenderer {
	items?: Array<{
		compactLinkRenderer: menuNavigationItemRenderer;
	} | {
		compactLinkRenderer: menuNavigationItemRenderer;
	} | {
				...
				horizontalCardListRenderer: {
					cards: Array<{
						...
						searchRefinementCardRenderer: {
							thumbnail: thumbnail;
							query: title;
							searchEndpoint: searchEndpoint152;
							trackingParams: string;
						};
					} | {
						searchRefinementCardRenderer: {
...
export interface runs {
	...
	navigationEndpoint?: clickTracking | navigationEndpoint | navigationEndpoints;
	style?: string;
	bold?: boolean;
	icon?: icon;
	loggingDirectives?: menuRenderer;
...
export interface watchNextEndScreenRenderer {
	...
	filters?: {
		searchFilterRenderer: {
			label: viewCount;
			navigationEndpoint?: searchEndpoint152;
			tooltip: string;
			trackingParams: string;
			status?: string;
		};
	...
	groups?: {
		searchFilterGroupRenderer: watchNextEndScreenRenderer;
	}[];
...
export interface searchEndpoint152 {
	clickTrackingParams: string;
	commandMetadata: commandMetadata;
	searchEndpoint: {
		query: string;
...
export interface scrollToEngagementPanelCommand {
	...
	continuationItems?: Array<{
		...
		playlistVideoRenderer: compactVideoRenderer;
	} | {
		playlistVideoRenderer: compactVideoRenderer;
	} | {
		playlistVideoRenderer: compactVideoRenderer;
...
export interface menuRenderer158 {
...
export interface itemSectionRenderer {
	contents: Array<{
		channelRenderer: endScreenPlaylistRenderer;
	} | {
		channelRenderer: endScreenPlaylistRenderer;
	} | {
		continuationItemRenderer: {
		...
		radioRenderer: compactRadioRenderer;
	} | {
	...
	targetId?: string;
	subMenu?: {
		searchSubMenuRenderer: watchNextEndScreenRenderer;
	};
...
export interface impressionEndpoints {
	clickTrackingParams?: string;
	commandMetadata: commandMetadata;
	feedbackEndpoint: {
...
export interface initialData {
	...
	topbar?: {
		desktopTopbarRenderer: {
			...
			topbarButtons: [
				{
					topbarMenuButtonRenderer: metadataBadgeRenderer;
				},
				{
					topbarMenuButtonRenderer: metadataBadgeRenderer;
				},
	...
	sidebar?: {
		playlistSidebarRenderer: menuRenderer;
	};
...
export interface content226 {
	sectionListRenderer: itemSectionRenderer | results;
}
interface FinalData {
	video: {
		initialData: initialData;
