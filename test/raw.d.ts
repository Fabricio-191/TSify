...
interface navigationEndpoint {
	...
	signInEndpoint?: signInEndpoint | signInEndpoint38 | signInEndpoint183 | {
...
interface openPopupAction {
	popup: menuRenderer180 | popup | popup92 | popup191 | {
		aboutThisAdRenderer: {
...
interface searchRefinementCardRenderer {
	...
	query: title;
	searchEndpoint: searchEndpoint172;
	trackingParams: string;
}
...
interface searchFilterRenderer {
	label: viewCount;
	navigationEndpoint?: searchEndpoint172;
	tooltip: string;
	trackingParams: string;
	status?: string;
}
...
interface thumbnailOverlays113 {
...
interface itemSectionRenderer {
	contents: Array<contents80 | contents314 | contents319 | {
		...
		radioRenderer: {
			...
			thumbnailOverlays: [
				thumbnailOverlays111,
				thumbnailOverlays113,
				thumbnailOverlays105
			];
			...
			items: [
				{
					playlistSidebarPrimaryInfoRenderer: {
						...
						menu: videoActions;
						thumbnailOverlays: thumbnailOverlays272[];
						navigationEndpoint: navigationEndpoints;
						description: decoratedPlayerBarRenderer;
						showMoreText: title;
					};
				},
				{
...
interface content255 {
	sectionListRenderer: sectionListRenderer;
}

interface contents319 {
...
interface thumbnailOverlays111 {
